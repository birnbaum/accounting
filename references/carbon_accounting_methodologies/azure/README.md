...
- `azure-carbon-optimization-methodology-2026-05.md` — **Compiled web crawl of the Azure Carbon Optimization methodology docs**, 2026-05-22. Covers: overview (`/azure/carbon-optimization/overview`), view-emissions page, emissions calculation methodology (`/power-bi/connect-data/azure-emissions-calculation-methodology`), and emissions terminology page. Verbatim extracts of all key definitions, allocation methodology, scope coverage (S1/S2 MBM/S3 Cat 1,2,4,5,9,12), billing/emissions divergence disclaimer, granularity (monthly, ~19-day lag), equipment lifetime (6 yr), excluded regions, and the "compute + storage + data transfer" usage definition.
